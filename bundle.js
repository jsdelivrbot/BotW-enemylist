...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _FoeList = __webpack_require__(191);

	var _FoeList2 = _interopRequireDefault(_FoeList);

	var _FoeDetail = __webpack_require__(193);

	var _FoeDetail2 = _interopRequireDefault(_FoeDetail);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_FoeList2.default, null),
	        _react2.default.createElement(_FoeDetail2.default, null)
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FoeList = function (_Component) {
	  _inherits(FoeList, _Component);

	  function FoeList() {
	    _classCallCheck(this, FoeList);

	    return _possibleConstructorReturn(this, (FoeList.__proto__ || Object.getPrototypeOf(FoeList)).apply(this, arguments));
	  }

	  _createClass(FoeList, [{
	    key: 'foeList',
	    value: function foeList() {
	      var _this2 = this;

	      return this.props.foes.map(function (foe) {
	        return _react2.default.createElement(
	          'li',
	          {
	            key: foe.name,
	            onClick: function onClick() {
	              return _this2.props.selectFoe(foe);
	            },
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ selectFoe: _index.selectFoe }, dispatch);
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(FoeList);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FoeDetail = function (_Component) {
	  _inherits(FoeDetail, _Component);

	  function FoeDetail() {
	    _classCallCheck(this, FoeDetail);

	    return _possibleConstructorReturn(this, (FoeDetail.__proto__ || Object.getPrototypeOf(FoeDetail)).apply(this, arguments));
	  }

	  _createClass(FoeDetail, [{
	    key: 'render',
	    value: function render() {
	      if (!this.props.foe) {
	        return _react2.default.createElement(
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(FoeDetail);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _activeFoe = __webpack_require__(195);

	var _activeFoe2 = _interopRequireDefault(_activeFoe);

	var _reducerFoes = __webpack_require__(196);

	var _reducerFoes2 = _interopRequireDefault(_reducerFoes);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  foes: _reducerFoes2.default,
	  activeFoe: _activeFoe2.default
	});
...
/***/ (function(module, exports) {
	...
	exports.default = function () {
	  return [{ name: 'Bokolin', weapon: 'Bokolin Club', drop: 'Bokolin Club' }, { name: 'Fire Wizardrobe', weapon: 'Fire Rod', drop: 'Fire Rod' }, { name: 'Moblin', weapon: 'Spiked Club', drop: 'Spiked Club' }, { name: 'Lynel', weapon: 'Lynel Spear', drop: 'Lynel Bow' }, { name: 'Frost Lizardfos', weapon: 'Enchanced Lizardfos Spear', drop: 'Enchanced Lizardfos Spear' }];
	};
