...
/***/ (function(module, exports) {
	...
	exports.default = function () {
	  return [{ name: 'Bokolin', weapon: 'Bokolin Club', drop: 'Bokolin Club' }, { name: 'Fire Wizardrobe', weapon: 'Fire Rod', drop: 'Fire Rod' }, { name: 'Moblin', weapon: 'Spiked Club', drop: 'Spiked Club' }, { name: 'Lynel', weapon: 'Lynel Spear', drop: 'Lynel Bow' }];
	};
